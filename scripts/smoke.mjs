...
import { ok, some, errVariant, none, matchTag, variant, tagged, unwrap, all, fromFlat, fromKeyed, fromEnum, isErr } from "../dist/index.js";
...
assert.deepEqual(all([some(1), none()]), { tag: "none", none: null });
